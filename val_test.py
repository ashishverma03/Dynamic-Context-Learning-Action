...
from Network.training import val_test_model

from torch.utils.data import DataLoader
from Loader import metric,test_voc_fetcher, voc_fetcher


from Loader.transformations import HORelationDefaultTrainTransform,HORelationDefaultValTransform
import torchvision

from Network import network_res_lstm_41, ho_relation
...
if __name__ == '__main__':
    ...
    model_dir = os.path.join(os.path.expanduser("~"), "Documents/Codes/HOR_featfuse/models")
    ...
    #Model
    net = network_res_lstm_41.Custom_Model(pretrained=True,device=device).to(device)
    ...
    val_test_model(net, device, criterion, val_data, eval_metric) 
