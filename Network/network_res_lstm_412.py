...
class Custom_Model(torch.nn.Module):
    def __init__(self,pretrained,device):
        ...
        self.class_predictor = torch.nn.Linear(in_features= self.feat_dim, out_features=11, bias=True)
        self.ctx_class_predictor = torch.nn.Linear(in_features= self.feat_dim, out_features=11, bias=True)
